...
namespace ADS::UI {
    ...
    public:
         ...
         * and font resources throughout the application lifecycle. Does not
         * perform SDL/ImGui setup — call init() explicitly once before use.
         */
         ...
         * Must be called exactly once, after construction, before the
         * manager is used.
         *
