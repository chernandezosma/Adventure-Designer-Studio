...
namespace ADS::Core {
    ...
    Entities::Scene* Project::addScene(const std::string& id, const std::string& name) {
        if (findScene(id) != nullptr) {
            spdlog::warn("Project: rejected duplicate Scene id '{}'", id);
            return nullptr;
        }
        ...
        spdlog::info("Project: added Scene '{}' ({})", id, name);
        return rawEntity;
    }

    void Project::removeScene(const std::string& id) {
        spdlog::info("Project: removing Scene '{}'", id);
        m_scenes.erase(
    ...
    Entities::Character* Project::addCharacter(const std::string& id, const std::string& name) {
        if (findCharacter(id) != nullptr) {
            spdlog::warn("Project: rejected duplicate Character id '{}'", id);
            return nullptr;
        }
        ...
        spdlog::info("Project: added Character '{}' ({})", id, name);
        return rawEntity;
    }

    void Project::removeCharacter(const std::string& id) {
        spdlog::info("Project: removing Character '{}'", id);
        m_characters.erase(
    ...
    Entities::Item* Project::addItem(const std::string& id, const std::string& name) {
        if (findItem(id) != nullptr) {
            spdlog::warn("Project: rejected duplicate Item id '{}'", id);
            return nullptr;
        }
        ...
        spdlog::info("Project: added Item '{}' ({})", id, name);
        return rawEntity;
    }

    void Project::removeItem(const std::string& id) {
        spdlog::info("Project: removing Item '{}'", id);
        m_items.erase(
