 ...
 * @brief Modal listing entities skipped, or loaded with defaulted fields,
 *        during a partial `.ads` project load
 *
...
namespace ADS::IDE {
    ...
    public:
         ...
         * @version Sep 2026
         *
         * @param warnings Entities skipped, or loaded with defaulted fields,
         *        by ProjectSerializer::load()
         */
    ...
    private:
        ...
        std::vector<Core::LoadWarning> m_warnings;      ///< entities flagged on the last open()
    };
